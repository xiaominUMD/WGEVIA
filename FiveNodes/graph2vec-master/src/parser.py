...
def parameter_parser():
    ...
    parser.add_argument("--input-path",
                        nargs = "?",
                        default = "../GCNWork/dataset/json/",    #changed to mine
	                    #default = "../GCNWork/dataset/genSample/",
	                help = "Input folder with jsons.")

    parser.add_argument("--output-path",
                        nargs = "?",
                        default = "./features/microcircuits.csv",
                        #default = "./features/gentest.csv",
    ...
    parser.add_argument("--origin",
                        type= int,
                        default=1,
                        help="1 as original method, 2 as modified")
